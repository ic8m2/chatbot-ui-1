...
AS $$
DECLARE
  project_url TEXT := 'https://kakbzxpwwrfgqnvmerpp.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Imtha2J6eHB3d3JmZ3Fudm1lcnBwIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTcxMDI5MzA4OSwiZXhwIjoyMDI1ODY5MDg5fQ.iS_Q_MZxq-IiYgCJ-LKC3OXG2Zt7birXtM3NdNAqXDw'; -- full access needed for http request to storage
